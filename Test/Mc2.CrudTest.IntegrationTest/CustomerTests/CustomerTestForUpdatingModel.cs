...
public class CustomerTestForUpdatingModel : BaseIntegrationTest
{
    ...
    public async Task happy_scenario_for_update_customer()
    {
        ...
        var updateCustomer = CustomerProvider.UpdateSomeCustomer("Mohammad", "farahani", "mfarahan8575@gmail.com",
            "12345678", DateOnly.FromDateTime(DateTime.Today.AddYears(-36)));
    ...
    public async Task not_valid_data_for_update_user_when_first_name_is_not_valid()
    {
        ...
        var updateCustomer = CustomerProvider.UpdateSomeCustomer("", "farahani", "mfarahan8575@gmail.com", "12345678",
            DateOnly.FromDateTime(DateTime.Today.AddYears(-36)));
